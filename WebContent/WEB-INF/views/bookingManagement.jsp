...
<html>
	<head>
		...
		<script type="text/javascript" src="resources/js/bookingManagement.js"></script>
	</head>
	<body>
		...
		<div id="create">
			<div class="form">
				<form method="post" action="createUserBooking" id="createForm">
			...
			<table class="table table-hover">
				...
				<c:forEach items="${allBookings}" var="booking">
					<tr>
						...
						<c:choose>
						<c:when  test="${booking.deleted == true}">
							<td>
								<form method="post" action="updateUserBooking">
                           ...
                           <div class="modal-content">
                            ...
                            <div class="modal-body">
                            	<form method="post" action="updateUserBooking" >
										...
										<label>Username</label>  	: <br/>&nbsp; <input id ="updateUsername" type="text" name = "username" ><br/><br>
...
<!-- ==========================================Delete Modal ===================================================-->
                     ...
                     <div class="modal-dialog">
                           <div class="modal-content">
                            ...
                            <label>Are you sure</label>
                            	<form method="post" action="deleteUserBooking" >
 ...
 <!-- ==========================================Reinstate Modal ===================================================-->
		        ...
		        <div id="reinstateBooking" class="modal fade" role="dialog">
                     <div class="modal-dialog">
                           <div class="modal-content">
                            <div class="modal-header">
                                         <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal-body">
                            <label>Are you sure</label>
                            	<form method="post" action="updateUserBookiong" >
										<input  type="hidden" name = "bookingId"  >
										<input  type="hidden" name = "deleted"  value="false">
										<input style="float: middle" type="submit" value="Reinstate" class="button"/>	
                           	 </form>
                            </div>
                           </div>
                     </div>
